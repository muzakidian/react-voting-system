...
const Ranking = ({ votes, candidates }) => {
  ...
  return (
    <div className="wrapper">
      {/* <h1 className="title mb-3">Certified Ranking of Candidates 2022</h1> */}
      <h1 className="title mb-3">Ranking</h1>
      <div className="list-container">
        <h3 className="title mb-3">Makanan</h3>
      ...
      <div className="list-container">
        <h3 className="title mb-3">Minuman</h3>
